...
return [
    ...
    'documentations' => [
        'default' => [
            ...
            /* 
             * CETTE SECTION CORRIGE L'ERREUR array_column 
             */
            'securityDefinitions' => [
                'securitySchemes' => [
                    'sanctum' => [
                        ...
                        'scheme' => 'bearer',
                        'bearerFormat' => 'JWT',
                        'description' => 'Entrez votre jeton API (Token) ici.',
                    ],
                ],
                'security' => [],
            ],
    ...
    /* On remplit aussi defaults pour être totalement sécurisé */
    'defaults' => [
        'routes' => [
            'docs' => 'docs',
